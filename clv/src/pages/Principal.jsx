...
<footer className='lg:mt-32 lg:bg-customGreen lg:h-20'>
      ...
      <div className="mb-4">
        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="numeroPersonas">
      ...
      <div className="mb-4">
        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="diaLlegada">
          Día de llegada: <span className="text-red-500">*</span>
        </label>
        <input
          type="date"
          name="diaLlegada"
          value={formData.diaLlegada}
          onChange={handleChange}
          className="w-full p-2 border border-gray-300 rounded"
          required
        />
      ...
      <div className="mb-4">
        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="diaSalida">
          Día de salida: <span className="text-red-500">*</span>
        </label>
        <input
          type="date"
          name="diaSalida"
          value={formData.diaSalida}
          onChange={handleChange}
          className="w-full p-2 border border-gray-300 rounded"
          required
        />
...
o simplemente completa este formulario a continuación y te contactaremos:
  ...
  <div className="max-w-lg mx-auto p-4">
      <form className="grid grid-cols-2 gap-4 bg-green-100 p-4 border border-green-400 rounded-lg">
        <input
          type="text"
          placeholder="Nombre"
